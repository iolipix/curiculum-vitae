const translations = {
    fr: {
        name: "Théophane Maurey",
        profession: "Juridique & Data Science",
        intro: "Bienvenue sur mon portfolio professionnel. Je suis un juriste passionné par l’ingénierie, les langues étrangères et l’aviation. Découvrez mon parcours, mes réalisations et mes centres d’intérêt.",
        nav: {
            law: "Droit",
    ...
    en: {
        name: "Théophane Maurey",
        profession: "Legal & Data Science",
        intro: "Welcome to my professional portfolio. I am a lawyer passionate about engineering, foreign languages, and aviation. Discover my journey, my achievements, and my areas of interest.",
        nav: {
            law: "Law",
    ...
    es: {
        name: "Théophane Maurey",
        profession: "Legal y Ciencia de Datos",
        intro: "Bienvenido a mi portafolio profesional. Soy un abogado apasionado por la ingeniería, los idiomas extranjeros y la aviación. Descubre mi trayectoria, mis logros y mis áreas de interés.",
        nav: {
            law: "Derecho",
    ...
    jp: {
        name: "テオファン・モレ",
        profession: "法務＆データサイエンス",
        intro: "私のプロフェッショナルポートフォリオへようこそ。私はエンジニアリング、外国語、航空に情熱を注ぐ弁護士です。私の経歴、業績、興味の分野をご覧ください。",
        nav: {
            law: "法律",
